...
public class CourseCategoryController extends BaseCategoryController {

    private static final String COURSE_CATEGORY_ID = "course";
    ...
    public List<ZTree> data(HttpServletRequest request, Integer open, String checkedids, CategoryDto categoryDto) {
        categoryDto.setCategoryId(COURSE_CATEGORY_ID);
        return super.dataBase(open, checkedids, categoryDto);
    }

    @RequestMapping("categoryList")
    public String categoryList() {
        return "/admin/category/course/list";
    }
    ...
    @ResponseBody
    public RestResult saveCategory(Category category) {
        if (StringUtils.isBlank(category.getPid())) {
            category.setPid(COURSE_CATEGORY_ID);
        }
    ...
    public String categoryShow(Integer type, Model model) {
        ...
        return "/admin/category/course/show";
    }
}
