...
import com.xxsowrd.xitem.admin.entity.system.Functions;
import com.xxsowrd.xitem.admin.entity.system.Role;
import com.xxsowrd.xitem.admin.model.TreeMenu;
...
public class MenuUtil {
    ...
    public static List<Functions> listFunctionsByRoleSet(Set<Role> roleSet) {
        Map<String, Functions> functions = Maps.newConcurrentMap();
        if (roleSet != null) {
    ...
    public static Set<Functions> functionMapToSet(Map<String, Functions> map) {
        Set<Functions> set = Sets.newConcurrentHashSet();
    ...
    public static List<Functions> listFunctionsByJSONArray(String jSONArrayFunctions, boolean show) {
        List<Functions> functionsList = Lists.newArrayList();
    ...
    private static void buildTreeMenu(TreeMenu treeMenu, List<Functions> functionsSet, int layer) {
        if (layer != 0) {
            List<TreeMenu> list = Lists.newArrayList();
