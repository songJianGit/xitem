                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="table-pagination"
                                           ...
                                           data-url="${ctx.contextPath}/admin/exam/userExamAuthData?examId=${examId}"
...
<script type="text/javascript">
    ...
    function userCallBack(ids) {
        $.ajax({
            url: '${ctx.contextPath}/admin/exam/addExamAuth',
            type: "post",
            cache: false,
            data: {
                userIds: ids.join(","),
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: '${ctx.contextPath}/admin/exam/delExamAuth',
                                type: "post",
                                cache: false,
                                data: {
                                    ids: ids.join(","),
    ...
    $('#searchBtn').click(function () {
        $("#table-pagination").bootstrapTable('refresh', {
            url: "${ctx.contextPath}/admin/exam/userExamAuthData?examId=${examId}&" + $("#searchform").serialize()
        });
    });
</script>
</body>
