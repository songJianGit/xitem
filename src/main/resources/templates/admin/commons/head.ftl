...
<title>xitem</title>
<link rel="shortcut icon" type="image/x-icon" href="${ctx.contextPath}/static/plugins/admin-template/favicon.ico">
<#--字体图标-->
<link href="${ctx.contextPath}/static/plugins/admin-template/css/materialdesignicons.min.css" rel="stylesheet">
<#--bootstrapV4框架-->
<link href="${ctx.contextPath}/static/plugins/admin-template/css/bootstrap.min.css" rel="stylesheet">
<#--动画效果-->
