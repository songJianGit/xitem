...
<script type="text/javascript">
    ...
    function caozuo(value, row) {
        ...
        htm += '<a class="btn btn-sm btn-default m-r-5" href="${ctx.contextPath}/admin/system/roleFunction?roleId=' + value + '" title="权限设置"><i class="mdi mdi-settings-outline"></i>权限设置</a>';
