// Project address: https://github.com/vipstone/bootstrap-paginator
"use strict";
var paginator = {
    ...
    show: function (currentPage) {
        ...
        if(this.totalPages>=5){
            createHtml += "<li style='padding: .5rem .75rem;line-height: 1.25;color: #2b2b2b'>共" + this.totalPages + "页</li>";
        }
        createHtml += '</ul>';
